...
function template_main()
{
	...
	<div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
		...
		foreach ($context['boards'] as $board)
		{
			...
			if (!empty($board['children']))
			{
				...
				echo '
				<tr id="board_', $board['id'], '_children" class="windowbg2"><td colspan="3" class="children td-children"><strong>', $txt['parent_boards'], '</strong>: ', implode(', ', $children), '</td></tr>';
			}
		}
		echo '
				</tbody>
	...
	<div class="tborder topic_table" id="messageindex">
		...
		if (!empty($settings['display_who_viewing']))
		{
			echo '
				<tr class="whos_viewing">
					<td colspan="', !empty($context['can_quick_mod']) ? '6' : '5', '" class="smalltext" id="whoisviewing">';
		...
		foreach ($context['topics'] as $topic)
		{
				...
				<tr>
					...
					<td class="subject ', $alternate_class, '">
						<div ', (!empty($topic['quick_mod']['modify']) ? 'id="topic_' . $topic['first_post']['id'] . '" onmouseout="mouse_on_div = 0;" onmouseover="mouse_on_div = 1;" ondblclick="modify_topic(\'' . $topic['id'] . '\', \'' . $topic['first_post']['id'] . '\');"' : ''), '>
							', $topic['is_sticky'] ? '<strong>' : '', '<span id="msg_' . $topic['first_post']['id'] . '" class="tsubject">', $topic['first_post']['link'], (!$context['can_approve_posts'] && !$topic['approved'] ? '&nbsp;<em>(' . $txt['awaiting_approval'] . ')</em>' : ''), '</span>', $topic['is_sticky'] ? '</strong>' : '';
			...
			echo '
							<p>', $txt['started_by'], ' ', $topic['first_post']['member']['link'], ' <span style="font-size: 9px;">', $txt['on'], ' ',$topic['first_post']['time'], '</span>
