...
function template_main()
{
	...
	<div id="newsfader">
		...
		<ul class="reset descriptionnews" id="smfFadeScroller"', empty($options['collapse_news_fader']) ? '' : ' style="display: none;"', '>';
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				<tr id="board_', $board['id'], '" class="windowbg">
					<td class="icon windowbg td-boards td-first"', !empty($board['children']) ? ' rowspan="2"' : '', '>
				...
				echo '
					...
					<td class="info windowbg td-boards">
				...
				// Show some basic information about the number of posts, etc.
					...
					<td class="lastpost windowbg td-boards td-last">';
				...
				if (!empty($board['children']))
				{
					...
					<tr id="board_', $board['id'], '_children" class="windowbg2">
						<td colspan="3" class="children td-children">
		...
		echo '
			<tbody class="divider">
				<tr>
					<td colspan="4"><hr class="divisorp" /></td>
				</tr>
			</tbody>';
	}
	echo '
	...
	<div id="posting_icons" class="floatleft">';
		...
		echo '
		<ul class="reset">
			<li class="floatleft"><img src="', $settings['images_url'], '/on.png" alt="" width="20" /> ', $txt['new_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/off.png" alt="" width="20" /> ', $txt['old_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/redirect.png" alt="" width="20" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
